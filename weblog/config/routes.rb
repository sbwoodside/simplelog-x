...
ActionController::Routing::Routes.draw do |map|
  ...
  # site ########################################################################################
  # index page
    map.connect '', :controller => 'portal', :action => 'list'
  # main blog display
  ...
  # rss feeds
    map.connect 'rss', :controller => 'portal', :action => 'everything_feed'
  ...
  # aggregator
    map.connect 'aggregator', :controller => 'aggregate', :action => 'index'
